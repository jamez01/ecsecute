...
require "ecsecute/version"

Gem::Specification.new do |spec|
  spec.name          = "ecsecute"
  spec.license       = "MIT"
  spec.version       = Ecsecute::VERSION
  spec.authors       = ["James Paterni"]
  spec.email         = ["james@ruby-code.com"]

  spec.summary       = %q{Write a short summary, because RubyGems requires one.}
  spec.description   = %q{Write a longer description or delete this line.}
 # spec.homepage      = "https://github.com/jamez01"
...
#    spec.metadata["source_code_uri"] = "TODO: Put your gem's pub"
#    spec.metadata["changelog_uri"] = "TODO: Put your gem's CHANGELOG.md URL here."
  ...
  spec.add_dependency "aws-sdk-ecs", "~> 1.128.0" 
